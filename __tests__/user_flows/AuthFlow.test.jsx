// __tests__/user_flows/AuthFlow.test.jsx
...
describe("Authentication Flow Integration", () => {
  ...
  it("Handles login failure correctly", async () => {
    ...
    await user.type(screen.getByTestId("email-field"), "wrong@example.com");
    await user.type(screen.getByTestId("password-field"), "WrongPassword123!");
  ...
  it("Handles network failures gracefully", async () => {
    ...
    await user.type(screen.getByTestId("email-field"), "test@example.com");
    await user.type(screen.getByTestId("password-field"), "Password123!");
